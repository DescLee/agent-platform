...
DESCRIPTORS: list[ConnectorDescriptor] = [
    ...
    ConnectorDescriptor(
        ...
        title="钉钉",
        icon="钉",
        blurb="使用消息、通讯录、文档与知识库、钉盘、日历、待办、邮箱、审批、智能表格和智能听记。",
        auth="none",
        two_way=False,
        fields=[],
        instructions=[],
    ...
    ConnectorDescriptor(
        ...
        title="飞书",
        icon="飞",
        blurb="使用消息与群组、通讯录、云文档与表格、任务、会议与妙记、邮箱和审批。",
        auth="none",
        two_way=False,
        fields=[],
        instructions=[],
    ...
    ConnectorDescriptor(
        ...
        title="企业微信",
        icon="企",
        blurb="使用通讯录、消息、文档、会议、日程、待办、表格、智能表格和智能文档。",
        auth="none",
        two_way=False,
        fields=[],
        instructions=[],
    ...
    ConnectorDescriptor(
        ...
        title="腾讯文档",
        icon="文",
        blurb="通过远程服务读取和管理授权范围内的腾讯文档与表格。",
        auth="oauth",
        two_way=False,
        fields=[],
