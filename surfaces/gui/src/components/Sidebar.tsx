  ...
  return (
    ...
    >
      ...
      <div className="brand px-3.5 pt-2.5 pb-2 flex items-center gap-2" data-tauri-drag-region>
        ...
        <div className="brand-wordmark text-[14px]">绿巨人<span className="beta-tag">测试版</span></div>
      </div>
      ...
      <div className="px-2.5 mt-1">
        <button
          ...
          data-testid="nav-greenboat-assistant"
          onClick={props.onOpenGreenboat}
        >
          <Icon name="sparkle" size={15} className="shrink-0" /> 绿舟助理
        </button>
      </div>
      ...
      <div className="px-2.5 mt-1">
        ...
        >
          ...
          <span className="flex-1">自动任务</span>
        </button>
      </div>
                ...
                <>
                  ...
                  {recentSessions.length > RECENT_PEEK && (
                    ...
                    >
                      {recentExpanded
                        ? "收起"
                        : `再显示 ${recentSessions.length - RECENT_PEEK} 项`}
                    </button>
                  )}
                </>
              )}
